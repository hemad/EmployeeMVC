package com.ft.example.controller;
...
import com.ft.example.constants.FTConstant;
import com.ft.example.model.Employee;
import com.ft.example.repository.EmployeeRepository;
...
public class EmployeeController {
	    ...
	    public String listEmployeeList(Model model) {
	        ...
	        model.addAttribute(FTConstant.EMPLOYEE_LIST, employeeList);
